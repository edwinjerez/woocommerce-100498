...
abstract class Skin_Base extends Elementor_Skin_Base {
	...
	protected function _register_controls_actions() {
		...
		add_action( 'elementor/element/uael-business-reviews/section_filters_controls/after_section_end', [ $this, 'register_info_controls' ], 20 );
		add_action( 'elementor/element/uael-business-reviews/section_filters_controls/after_section_end', [ $this, 'register_date_controls' ], 20 );
		add_action( 'elementor/element/uael-business-reviews/section_filters_controls/after_section_end', [ $this, 'register_rating_controls' ], 20 );
		add_action( 'elementor/element/uael-business-reviews/section_filters_controls/after_section_end', [ $this, 'register_content_controls' ], 20 );

		add_action( 'elementor/element/uael-business-reviews/section_filters_controls/after_section_end', [ $this, 'register_box_style_controls' ], 20 );
		add_action( 'elementor/element/uael-business-reviews/section_filters_controls/after_section_end', [ $this, 'register_spacing_controls' ], 20 );
		add_action( 'elementor/element/uael-business-reviews/section_filters_controls/after_section_end', [ $this, 'register_navigation_controls' ], 20 );
		add_action( 'elementor/element/uael-business-reviews/section_filters_controls/after_section_end', [ $this, 'register_typography_controls' ], 20 );
	}
