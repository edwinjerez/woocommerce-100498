...
class Business_Reviews extends Common_Widget {
	...
	protected function register_general_controls() {
		...
		$this->add_control(
			...
			$this->add_control(
				'place_id',
				[
					'label'       => __( '<b>Google Place ID</b>', 'uael' ),
			...
			$this->add_control(
				'yelp_business_id',
				[
					'label'       => __( '<b>Yelp Business ID</b>', 'uael' ),
					'type'        => Controls_Manager::TEXT,
					'label_block' => true,
					'dynamic'     => [
						'active' => true,
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %s admin link */
					'raw'             => sprintf( __( 'Click %1$s here %2$s to find your Yelp Business ID.', 'uael' ), '<a href="https://uaelementor.com/docs/find-yelp-business-id/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">', '</a>' ),
					'content_classes' => 'uael-editor-doc',
					'condition'       => [
						'review_type!' => 'google',
					],
		...
		if ( parent::is_internal_links() ) {
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %s admin link */
					'raw'             => sprintf( __( 'Google allows maximum 5 reviews. Click <a href="%s" target="_blank" rel="noopener">here</a> to know more.', 'uael' ), 'https://uaelementor.com/docs/maximum-number-of-reviews-for-google-and-yelp/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin' ),
					'content_classes' => 'uael-editor-doc',
					'condition'       => [
						'review_type' => 'google',
					],
		...
		if ( parent::is_internal_links() ) {
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %s admin link */
					'raw'             => sprintf( __( 'Yelp allows maximum 3 reviews. Click <a href="%s" target="_blank" rel="noopener">here</a> to know more.', 'uael' ), 'https://uaelementor.com/docs/maximum-number-of-reviews-for-google-and-yelp/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin' ),
					'content_classes' => 'uael-editor-doc',
					'condition'       => [
						'review_type' => 'yelp',
					],
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %s admin link */
					'raw'             => sprintf( __( 'We can fetch only up to 5 Google and 3 Yelp Reviews. So, a maximum of 8 reviews can be displayed. Click <a href="%s" target="_blank" rel="noopener">here</a> to know more.', 'uael' ), 'https://uaelementor.com/docs/maximum-number-of-reviews-for-google-and-yelp/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin' ),
					'content_classes' => 'uael-editor-doc',
					'condition'       => [
						'review_type' => 'all',
					],
	...
	/**
	 * Register Business Reviews Schema Markup Controls.
	 *
	 * @since 1.13.0
	 * @access public
	 */
	public function register_schema_controls() {
		$this->start_controls_section(
			'section_schema',
			[
			...
			$this->add_control(
				'rating_schema_switch',
				[
					'label'        => __( 'Enable Rating Schema', 'uael' ),
					'type'         => Controls_Manager::SWITCHER,
					'return_value' => 'yes',
					'default'      => 'no',
				]
		...
		if ( parent::is_internal_links() ) {
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %s admin link */
					'raw'             => sprintf( __( '<b>Important Note:</b> Adding schema gives SEO benefits. Please read %1$s this article %2$s before using Schema.', 'uael' ), '<a href="https://uaelementor.com/docs/schema-support-for-business-reviews/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">', '</a>' ),
					'content_classes' => 'uael-editor-doc',
				]
			);
		}
			...
			$this->add_control(
				'schema_type',
				[
					'label'     => __( 'Schema Type', 'uael' ),
					'type'      => Controls_Manager::SELECT,
					'default'   => 'Place',
					'options'   => array(
						'Place'        => __( 'Place', 'uael' ),
						'Organization' => __( 'Organization', 'uael' ),
						'Service'      => __( 'Service', 'uael' ),
					),
					'condition' => [
						'rating_schema_switch' => 'yes',
					],
				]
			);
		...
		if ( parent::is_internal_links() ) {
			...
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf( __( '%1$s Getting started article » %2$s', 'uael' ), '<a href="https://uaelementor.com/docs/business-reviews-widget/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">', '</a>' ),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf( __( '%1$s How to get Google Places API Key? » %2$s', 'uael' ), '<a href="https://uaelementor.com/docs/get-google-places-api-key/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">', '</a>' ),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf( __( '%1$s How to find Google Place ID? » %2$s', 'uael' ), '<a href="https://uaelementor.com/docs/find-google-place-id/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">', '</a>' ),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf( __( '%1$s How to get Yelp API Key? » %2$s', 'uael' ), '<a href="https://uaelementor.com/docs/get-yelp-api-key/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">', '</a>' ),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf( __( '%1$s How to find Yelp Business ID? » %2$s', 'uael' ), '<a href="https://uaelementor.com/docs/find-yelp-business-id/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">', '</a>' ),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf( __( '%1$s Unable to display more than 5 Google/3 Yelp Reviews? » %2$s', 'uael' ), '<a href="https://uaelementor.com/docs/maximum-number-of-reviews-for-google-and-yelp/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">', '</a>' ),
					'content_classes' => 'uael-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s doc link */
					'raw'             => sprintf( __( '%1$s Schema Support » %2$s', 'uael' ), '<a href="https://uaelementor.com/docs/schema-support-for-business-reviews/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">', '</a>' ),
					'content_classes' => 'uael-editor-doc',
				]
			);
