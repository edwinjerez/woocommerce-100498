...
<div <?php echo $this->get_parent_wrapper_attributes( $settings ); ?>>
	<div <?php echo $this->get_render_attribute_string( 'inner-wrapper' ); ?>>
		<div class="uael-content">
			...
			if (
				(
					( 'icon' == $settings['close_source'] && '' != $settings['close_icon'] ) ||
			...
			<div class="uael-modal-title-wrap">
				<<?php echo $settings['title_tag']; ?> class="uael-modal-title elementor-inline-editing" data-elementor-setting-key="title" data-elementor-inline-editing-toolbar="basic"><?php echo $this->get_settings_for_display( 'title' ); ?></<?php echo $settings['title_tag']; ?>>
			</div>
			<?php } ?>
