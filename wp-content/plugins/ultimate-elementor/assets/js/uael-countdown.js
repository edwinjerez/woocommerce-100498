( function ( $ ) {
  ...
  */  
  UAELCountdown = {
      ...
      */
      _calculateTime: function( wrapper, scope_id ) {
          ...
          var distance = Cookies.get( 'uael-timer-runTimer-' + scope_id ) - currentTime;

          Cookies.set( 'uael-timer-distance-' + scope_id, distance, { path: '/' } );

          var dist_action = Cookies.get( 'uael-timer-distance-' + scope_id ); 
          var countdown_animation = Cookies.get( 'uael-countdown-animation-' + scope_id );
          var countdown_animation_miliseconds = countdown_animation * 60000;

          if ( dist_action <= countdown_animation_miliseconds ) {
      ...
      */
          ...
          switch ( action ) {
              ...
              case 'show_message':
                  ...
                  if ( elementorFrontend.isEditMode() ){
                      ...
                      wrapper.addClass( 'countdown-expire' );
                      wrapper.addClass( 'uael-countdown-show-message' );
                  } 
      ...
      _evergreenTimer: function( wrapper, scope_id ) {
          ...
          clearInterval( countdownInterval[ scope_id ] );
          Cookies.set( 'uael-timer-runTimer-' + scope_id, runTimer, { path: '/' } );
      },
      /**
      ...
      _fixedTimer :function( wrapper, scope_id ) {
          ...
          var cd_time_fixed = new Date( cd_date ).getTime();
        
          // Find the distance between now an the count down date
          clearInterval( countdownInterval[ scope_id ] );
          Cookies.set( 'uael-timer-runTimer-' + scope_id, cd_time_fixed, { path: '/' } );
      },
      /**
      ...
      _recurringTimer :function( wrapper, scope_id ) {
          ...
          resetInterval[ scope_id ] = setInterval( function() {
              ...
              var reset_time = new Date( wrapper.data ( 'start-date' ) ).getTime();
  ...
  var WidgetUAELCountdown = function( $scope, $ ) {
      ...
      Cookies.set( 'uael-countdown-animation-' + scope_id , start_animation, { path: '/' } );
      ...
      if ( 'evergreen' == type || 'fixed' == type || new Date( wrapper.data ( 'start-date' ) ).getTime() <= new Date().getTime() ) {
        clearInterval( resetInterval[ scope_id ] );          
        clearInterval( countdownInterval[ scope_id ] );
