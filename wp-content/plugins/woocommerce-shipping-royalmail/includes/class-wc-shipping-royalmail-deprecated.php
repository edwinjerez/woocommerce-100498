<?php
/**
 * Deprecated RoyalMail shipping method.
 *
...
class WC_Shipping_Royalmail extends WC_Shipping_Method {
	...
	private $services = array(
		...
		'parcelforce-express-9'		   => 'Parcelforce Worldwide express9',
		'parcelforce-express-10'	   => 'Parcelforce Worldwide express10',
		'parcelforce-express-am'	   => 'Parcelforce Worldwide expressAM',
		'parcelforce-express-24'	   => 'Parcelforce Worldwide express24',
		'parcelforce-express-48'	   => 'Parcelforce Worldwide express48',
	...
	public function __construct() {
		...
		$this->method_description = __( 'Offer Royal Mail shipping rates automatically to your customers. Prices according to <a href="http://www.royalmail.com/sites/default/files/Royal-Mail-Our-Prices-March-2017_0.pdf">the 2017 price guide</a>.', 'woocommerce-shipping-royalmail' );
		$this->init();
	}
	...
	private function environment_check() {
		if ( 'GBP' !== get_woocommerce_currency() ) {
			$this->display_error_message( __( 'Royal Mail requires that the currency is set to British Pounds.', 'woocommerce-shipping-royalmail' ) );
		}

		if ( 'GB' !== WC()->countries->get_base_country() ) {
			$this->display_error_message( __( 'Royal Mail requires that the base country/region is set to United Kingdom.', 'woocommerce-shipping-royalmail' ) );
		}
	}
	...
	private function display_error_message( $message ) {
		...
		$link = "<a href='$url'>" . esc_html( __( 'Click here to change.', 'woocommerce-shipping-royalmail' ) ) . '</a>';
