 ...
 * @since 2.0.0
 */
class SP_Pricing_Tables_Layout_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		<div style="overflow: hidden; zoom: 1;">
			...
			<label style="width: 30.75%; float: left; margin-right: 3.8%; text-align: center; margin-bottom: 1.618em;">
				<img src="<?php echo SP_PLUGIN_URL . 'includes/customizer/pricing-tables/assets/images/left.png'; ?>" alt="Left" style="display: block; width: 100%; margin-bottom: .618em" />
			...
			<label style="width: 30.75%; float: left; text-align: center; margin-right: 3.8%; margin-bottom: 1.618em;">
				<img src="<?php echo SP_PLUGIN_URL . 'includes/customizer/pricing-tables/assets/images/center.png'; ?>" alt="Center" style="display: block; width: 100%; margin-bottom: .618em" />
			...
			<label style="width: 30.75%; float: right; text-align: center; margin-bottom: 1.618em;">
				<img src="<?php echo SP_PLUGIN_URL . 'includes/customizer/pricing-tables/assets/images/right.png'; ?>" alt="Right" style="display: block; width: 100%; margin-bottom: .618em" />
