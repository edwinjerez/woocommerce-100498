...
class SP_Mega_Menus_Admin {
	...
	public function register_smm_sidebar() {
		register_sidebar( array(
			'name'			=> __( 'SMM Sidebar', 'storefront-powerpack' ),
			'id'			=> 'smm-sidebar',
			'description'	=> __( 'Widgets in this area will be shown on all posts and pages.', 'storefront-powerpack' ),
