...
class SP_Mega_Menus_Frontend {
	...
	public function enqueue_frontend_scripts() {
		wp_enqueue_style( 'storefront-mega-menus-frontend', SP_Mega_Menus()->plugin_url . 'assets/css/frontend.css', array(), SP_Mega_Menus()->version, 'all' );
		wp_style_add_data( 'storefront-mega-menus-frontend', 'rtl', 'replace' );
	}
