...
define( 'WC_SHIPPING_UPS_VERSION', '3.2.17' );
...
class WC_Shipping_UPS_Init {
	...
	public function includes() {
		include_once( dirname( __FILE__ ) . '/includes/class-wc-shipping-ups-privacy.php' );
	...
	public function plugin_links( $links ) {
		$plugin_links = array(
			'<a href="https://woocommerce.com/my-account/create-a-ticket?select=18665">' . __( 'Support', 'woocommerce-shipping-ups' ) . '</a>',
			'<a href="https://docs.woocommerce.com/document/ups-shipping">' . __( 'Docs', 'woocommerce-shipping-ups' ) . '</a>',
		);
	...
	public function wc_deactivated() {
		echo '<div class="error"><p>' . sprintf( __( 'WooCommerce UPS Shipping requires %s to be installed and active.', 'woocommerce-shipping-ups' ), '<a href="https://wordpress.org/plugins/woocommerce/" target="_blank">WooCommerce</a>' ) . '</p></div>';
	}
