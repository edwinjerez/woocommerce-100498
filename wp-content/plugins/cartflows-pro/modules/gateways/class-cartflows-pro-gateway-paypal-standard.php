							...
							'<?php echo $this->get_woo_payer_id(); ?>',
							{
								...
								click: function () {
									...
									var postData = {
										...
										order_id: <?php echo isset( $_GET['wcf-order'] ) ? $_GET['wcf-order'] : 0; ?>,
										order_key: '<?php echo isset( $_GET['wcf-key'] ) ? $_GET['wcf-key'] : ''; ?>',
										session_key: '<?php echo isset( $_GET['wcf-sk'] ) ? $_GET['wcf-sk'] : ''; ?>',
